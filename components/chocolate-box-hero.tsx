...
export function ChocolateBoxHero() {
  return (
        ...
        <div className="pb-8 sm:pb-14">
          ...
          <div className="relative -mx-4 -mt-8 mb-5 h-[275px] overflow-hidden sm:hidden">
            <iframe
              ...
              title="Chocolate Box Manufacturer Video"
          ...
          <p className="mb-5 hidden max-w-[500px] text-sm text-[#9999bb] sm:mb-7 sm:block sm:text-[17px]">
            Looking for a trusted chocolate box manufacturer, chocolate packaging supplier, or chocolate packaging factory in India? We design and manufacture premium custom chocolate boxes, luxury rigid packaging, sweet gift boxes, and branded chocolate packaging for growing and established brands.
          </p>
          ...
          <div className="mt-6 flex flex-col gap-3 sm:hidden">
            ...
            <a
              href="https://wa.me/918448395560?text=Hello%2C+I+need+a+chocolate+box+packaging+quote"
              target="_blank"
