...
const chips = [
  ...
  "Eco Friendly Bags",
  "Handle Carry Bags",
  "Premium Branding Bags",
  "Bulk Carry Bag Manufacturing",
]
        ...
        <div className="pb-8 sm:pb-14">
          ...
          <div className="relative -mx-4 -mt-8 mb-5 h-[275px] overflow-hidden sm:hidden">
            <iframe
              ...
              title="Carry Bag Manufacturer Video"
          ...
          <p className="mb-5 hidden max-w-[500px] text-sm text-[#9999bb] sm:mb-7 sm:block sm:text-[17px]">
            Looking for a reliable carry bag manufacturer, paper bag supplier, or packaging bag factory in India? We manufacture premium custom carry bags, kraft paper bags, luxury shopping bags, and eco-friendly retail packaging solutions for brands across India and global markets.
          </p>
          ...
          <div className="mt-6 flex flex-col gap-3 sm:hidden">
            ...
            <a
              href="https://wa.me/918448395560?text=Hello%2C+I+need+a+carry+bag+quote"
              target="_blank"
