...
export function CosmeticsPackagingHero() {
  return (
        ...
        <div className="pb-8 sm:pb-14">
          ...
          <div className="relative -mx-4 -mt-8 mb-5 h-[275px] overflow-hidden sm:hidden">
            <iframe
              ...
              title="Cosmetic Packaging Manufacturer Video"
          ...
          {/* DESCRIPTION */}
          <p className="mb-5 hidden max-w-[520px] text-sm text-[#9999bb] sm:mb-7 sm:block sm:text-[17px]">
            Looking for a trusted cosmetic packaging manufacturer in India? We design and manufacture premium cosmetic boxes, skincare and makeup packaging, luxury beauty cartons, and custom printed packaging solutions for emerging and established brands.
          </p>
          ...
          <div className="mt-6 flex flex-col gap-3 sm:hidden">
            ...
            <a
              href="https://wa.me/918448395560?text=Hello%2C+I+need+a+cosmetic+packaging+quote"
              target="_blank"
